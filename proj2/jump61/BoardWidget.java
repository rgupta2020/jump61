...
class BoardWidget extends Pad {
    ...
    public synchronized void paintComponent(Graphics2D g) {
        ...
        for (int i = 0; i < _board.size()*_board.size(); i++) {
            ...
            if (_board.get(i).getSide() == RED) {
                g.setColor(RED_TINT);
                g.fillRect(53*(_board.row(i)-1), 53*(_board.col(i)-1), 50, 50);
            } else if (_board.get(i).getSide() == BLUE) {
            ...
            displaySpots(g, _board.row(i), _board.col(i));
    ...
    private void displaySpots(Graphics2D g, int r, int c) {
        ...
        int spots = _board.get(_board.sqNum(r, c)).getSpots();
        switch(spots) {
            case 1:
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/2), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/2));
                break;
            case 2:
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+3*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+3*(SQUARE_SIZE/4));
                break;
            case 3:
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+3*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+3*(SQUARE_SIZE/4));
            ...
            case 4:
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+3*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+3*(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+3*(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+3*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                break;
            case 5:
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/2), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/2));
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
            ...
            case 6:
                ...
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+3*(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+3*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+2*(SQUARE_SIZE/4));
                spot(g, (SQUARE_SEP*(r-1))+2*(SQUARE_SIZE/4), (SQUARE_SEP*(c-1))+(SQUARE_SIZE/4));
                break;
        }
    }
    ...
    public void doClick(String dummy, MouseEvent event) {
        ...
        getGraphics().drawString(r +" " + c, 50, 50);
        if(_board.sqNum(r, c) < _board.size()*_board.size()) {
